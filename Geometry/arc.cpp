...
/*
    Calculates the area of a circular sector defined by an arc from a to b.
    (The region bounded by the arc and the two radii to a and b).
*/
...
/*
    Calculates the area of a circular segment defined by an arc from a to b.
    (The region bounded by the arc and the chord connecting a and b).
*/
...
/*
    Checks if a point p lies on the circular arc from a to b centered at c.
    Input: Circle center, radius, arc endpoints (a, b), and the point to test (p).
    Output: True if the point lies on the arc, False otherwise.
*/
...
/*
    Finds the intersection points of a circular arc and an line. 
    Input: Circle center, radius, arc endpoints (a, b), and an infinite line.
    Output: Vector of valid intersection points (0, 1, or 2 points).
*/
...
/*
    ...
    Input: Centers, radii, and endpoints (a, b) for two arcs.
    Output: Vector of valid intersection points (0, 1, or 2 points).
*/
...
/*
    Calculates the shortest distance from a point to a circular arc.
    Input: Circle center, radius, arc endpoints (a and b), and the point to test (p).
*/
...
/*
    ...
    Input: Circle center, radius, and the two endpoints of the arc (a and b).
    Output: A pair of points representing the {bottom-left, top-right} corners of the bounding box.
*/
